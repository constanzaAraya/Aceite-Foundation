...
<html lang="es">
  ...
  <body>
    <header>
      <h2 align="center">INFORMES ANÁLISIS DE ACEITE</h2>
    </header>
    <?php
    ...
    <div class="small-9 small-centered columns" id="contenido">           
      <div class="row">

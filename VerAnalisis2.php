		...
		if (isset($_GET['id']) && $_GET['id'] != "")
		{
			...
			<div class="row">
				<div class="col s12">
					...
					<h4 align="center">Detalle Informe <?php echo $fila["Nombre"] ?><br/>
					<?php 
						echo "Realizado por ".$fila["Proveedor"]." el ".$fila["Fecha1"]; 
			...
			<div class="row">
				<div class="col s6 push-s3 l4 push-l4 m4 push-m4 blue lighten-4">
					<br />
			...
			<div class="row">
				<div class="col s12">
					<p align="center">
						<a class="waves-effect waves-light btn" href="#" id="agregarDato">Agregar Datos</a>
						<a class="waves-effect waves-light btn" href="index.php">Volver</a>
					</p>
				</div>
			</div>
